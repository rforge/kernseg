...
void Call_BinSeg (double * dataVec_, double * weights_, int * Kmax_, int * n_, int * P_, int * Ruptures_, double * RupturesCost_){
	...
	BinSeg_MultiDim BinSegRun(data, weights_, n, P, 2*Kmax + 10);
